...
////        > Piece of Code that can perform a particular task.
///
/// ### Key Components of Java Functions
/// - Definition/ Declaration - A function must be declared within a class.
/// `public returnType functionName(parameterType parameterName) {
///     // body of the function
/// }`
///
/// - **Calling** - Until you call the function, You can't run it.
///     - `functionName(arguments);`
///
///
/// Main is also a function, which is called by the JVM
public class Lab001UserdefinedFunction {
